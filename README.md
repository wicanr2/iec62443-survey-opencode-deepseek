...
<p align="center">
  <b>29 篇深度文章 · 27 張原創 SVG 架構圖 · 繁體中文</b><br>
  <sub>核心：IEC 62443-4-2（組件）× 4-1（開發）× 硬體信任根　·　延伸：3-3 / 3-2 / 2-1 / 1-6 全族</sub>
</p>

---

> **基於標準**：IEC 62443-4-2:2019 (ED1)（ANSI/ISA 版為 2018）+ IEC 62443-4-1:2018
> **修訂動態**：4-2 有 `prAA:2026` 修訂案進行中；引用時注意 IEC/ISA 雙編號差異，以 [IEC Webstore](https://webstore.iec.ch) 最新版為準
> **認證方案**：ISASecure CSA 1.0.0
> **知識庫版本**：v0.1.0（2026-06-30）— 見 [CHANGELOG.md](CHANGELOG.md)
...
| 🌐 系統整合商/業主 | **[06 超出核心 →](docs/06-beyond-4x/README.md)** | 3-3 系統 SR、3-2 SL-T 怎麼來、2-1 業主計畫、1-6 IIoT |
...
├── 🌐 06-beyond-4x/     (4 篇)       超出核心：3-3 SR · 3-2 ZCR · 2-1 業主 · 1-6 IIoT
│
